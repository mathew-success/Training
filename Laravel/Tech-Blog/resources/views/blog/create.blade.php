            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-md-5">
				<div class="row">
                    <div class="col-sm-10 text-left">
                        <h3>Create your blogs here!</h3>
                    </div>
					<div class="col-sm-2 text-right">
						<a href="{{route('blog.index')}}" class="btn btn-sm btn-primary">View Blogs</a>
					</div>
                </div>
				<br/>
				@if(session('message'))
				...
				<form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="short_description" value="{{old('short_description')}}" id="" class="form-control">
					<br/>
