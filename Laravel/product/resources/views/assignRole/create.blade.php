                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            @else
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="check{{ $permission->id }}" name="permission_id[]" value="{{ $permission->permission_id }}">
                                    <label class="form-check-label" for="check{{ $permission->id }}">{{ $permission->permission->name }}</label>
                                </div>
                                @endforeach
                            @endif
                        </div>
